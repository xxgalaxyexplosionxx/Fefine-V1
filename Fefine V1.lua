...
Section:NewToggle("AntiVoid", "Prevents you from falling into the void (Abusing may cause lagbacks.)", function(state)
	if state then
		voidjump = Instance.new("Part")
		voidjump.Parent = workspace
		voidjump.Name = "AntiVoid"
		voidjump.Position = Vector3.new(0, FallenPartsDestroyHeight.Value + 25, 52)
